    ...
    public static void main(final String[] args) {
        ...
        if (choice != 5) {// choice to end program will be 5
            ...
            while (!s.equalsIgnoreCase("quit")) {
                ...
                System.out.println("Please enter integer for second array list: ");// enter first integer for second
                                                                                   // array
                arrayY.add(scan.nextInt());
                System.out.println("If you are done adding numbers type 'quit', if not type any letter");// any letter
                                                                                                         // will keep
                                                                                                         // the progrm
                                                                                                         // running
                s = scan.next();
        ...
        {
            System.out.print("Attaching the arrays together creates this: " + arrayX.addAll(arrayY));// adds arrayY to
                                                                                                     // arrayX
        }
